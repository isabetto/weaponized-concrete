export const projects = [
  ...
  },
  {
    slug: 'base-app',
    title: 'BASE',
    kicker: 'UI/UX-design · Mobiele app',
    color: 'mustard',
    summary:
    ...
    details: [
      ...
      'De app is getest met usability- en user experience-tests onder de daadwerkelijke doelgroep, en op basis daarvan verder verfijnd.',
    ],
  },
  {
    slug: 'langspeelplaat',
